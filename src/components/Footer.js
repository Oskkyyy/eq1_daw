...
<div class="container">
  <div class="row justify-content-lg-between">
    <h5 class="lh-lg fw-bold text-white">En todas las alcaldías de Ciudad de México</h5>
    <div class="col-6 col-md-4 col-lg-auto mb-3">
      <ul class="list-unstyled mb-md-4 mb-lg-0">
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Álvaro Obregón</a></li>
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Azcapotzalco</a></li>
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Benito Juárez</a></li>
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Coyoacán</a></li>
      </ul>
    </div>
    <div class="col-6 col-md-4 col-lg-auto mb-3">
      <ul class="list-unstyled mb-md-4 mb-lg-0">
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Cuajimalpa de Morelos</a></li>
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Cuauhtémoc</a></li>
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Gustavo A. Madero</a></li>
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Iztacalco</a></li>
      </ul>
    </div>
    <div class="col-6 col-md-4 col-lg-auto mb-3">
      <ul class="list-unstyled mb-md-4 mb-lg-0">
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Iztapalapa</a></li>
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Magdalena Contreras</a></li>
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Miguel Hidalgo</a></li>
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Milpa Alta</a></li>
      </ul>
    </div>
    <div class="col-6 col-md-4 col-lg-auto mb-3">
      <ul class="list-unstyled mb-md-4 mb-lg-0">
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Tláhuac</a></li>
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Tlalpan</a></li>
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Venustiano Carranza</a></li>
        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Xochimilco</a></li>
      </ul>
    </div>
  </div>
  <hr class="text-900" />
